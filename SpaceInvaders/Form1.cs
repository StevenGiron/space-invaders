...
namespace SpaceInvaders
{
    public partial class Form1 : Form
    {
        ...
        private void generarDisparo()
        {
            ...
            Disparo disparo = new(1, "disparo.png", posicionDisparo, SpaceComponent.generarTamaño(20, 55), false);
        ...
        private void generarDisparoAlien()
        {
            ...
            Disparo disparoAlien = new(1, "disparoAlien.png", posicionDisparo, SpaceComponent.generarTamaño(32, 62), true);
